    ...
    <div class="two-col">
        ...
        <div class="panel">
            ...
            @forelse($rules as $rule)
                <div style="display:flex;align-items:center;justify-content:space-between;padding:12px 0;border-bottom:1px solid #f5eaea">
                    <div>
                    ...
                    <span style="background:#f5eaea;color:#8b1c2c;font-weight:800;font-size:.78rem;padding:4px 12px;border-radius:20px;flex-shrink:0;margin-left:10px">
                +{{ $rule->points }} pts
            </span>
                </div>
            @empty
